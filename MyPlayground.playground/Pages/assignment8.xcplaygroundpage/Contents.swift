...
class BankAccount: CheckingAccount {
    ...
    // balance and account and routing can be added to extension
...
class Bank { // use account number as index
...
print(chaseBank.getAccount(index: 1)?.balance) // first account balance 1350
